...
#
# Comments must sit on their own line — a `# comment` after the trailing `\`
# makes zsh/bash treat the line continuation as part of the comment and break
# the command into pieces.
...
# Comments must sit on their own line — a `# comment` after the trailing
# backtick makes PowerShell treat the line continuation as part of the
# comment and break the command into pieces.

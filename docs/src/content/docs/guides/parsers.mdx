---
title: Parser Guide
description: Choose the right parser — generic CSV/JSON, or benchmark output from Go, Rust (Criterion, Divan), and JavaScript (Vitest, Tinybench).
---

import { Aside, Tabs, TabItem } from '@astrojs/starlight/components';

Vizb reads **generic CSV/JSON tables and multiple benchmark frameworks** through its parser
...
Each tabular format — and each benchmark framework — produces output in a different shape. Vizb's

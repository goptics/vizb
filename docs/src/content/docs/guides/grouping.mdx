...
| Repeatable flags | Multiple datasets in one HTML (tabs in the UI) |
...
# Multi-view: two plots from one CSV
...
| **Several coordinate views** from one file | Repeatable solo `--select` | `--select region,latency --select region,sales` |

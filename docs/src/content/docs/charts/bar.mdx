...
Sample orders below (copy → `sales.csv`). The full file in the repo is [`examples/csv/sales.csv`](https://github.com/goptics/vizb/blob/main/examples/csv/sales.csv) — about **500 rows across 2024–2025**. Live dashboards: [tabular-data](https://vizb.goptics.org/examples/live/tabular-data/).

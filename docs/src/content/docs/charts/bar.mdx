...
```bash
vizb data.csv -g category -c bar -o out.html
```
...
```bash
vizb data.csv -g category,metric -p x/y -c bar -o out.html
```
...
```bash
vizb data.csv -g category,metric,group -p x/y/z -c bar -o out.html
```
...
vizb data.csv -g category,metric --chart bar:sort=asc,labels -o out.html

# Log scale on the bar chart only
vizb data.csv -g category,metric --chart bar:scale=log -o out.html
```

...
This example splits `order_date` into month and day slots (same grouping as the [Sales by Date](https://vizb.goptics.org/examples/csv/?id=02-sales-by-date) CSV dashboard) and maps `category` to the Z axis.

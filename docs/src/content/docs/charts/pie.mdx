...
<InvokeTabs
  cli={`vizb pie sales.csv -g region -o out.html`}
  input={SALES_SAMPLE}
/>
...
<InvokeTabs
  cli={`vizb pie sales.csv -g region,category -p x,y -o out.html`}
  input={SALES_SAMPLE}
/>
...
<InvokeTabs
  cli={`vizb pie sales.csv -g order_date,category -p "[-y{Month}-x{Date}],z{Category}" -o out.html`}
  input={SALES_SAMPLE}
/>

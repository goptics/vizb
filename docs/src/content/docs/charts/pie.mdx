...
This example splits `order_date` into month and day slots (same grouping as the [Sales by Date](https://vizb.goptics.org/examples/tabular-data/?id=02-sales-by-date) tabular-data dashboard) and maps `category` to the Z axis.

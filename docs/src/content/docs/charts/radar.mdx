...
import { RADAR_PROFILES_SAMPLE } from '../../../data/samples';
...
<InvokeTabs
	cli={`vizb radar profiles.csv -g metric -o out.html`}
	input={RADAR_PROFILES_SAMPLE}
/>
...
<InvokeTabs
	cli={`vizb radar profiles.csv -g subject,metric -p x,y -o out.html`}
	input={RADAR_PROFILES_SAMPLE}
/>
...
<InvokeTabs
	cli={`vizb radar profiles.csv -g subject,metric,tier -p x,y,z -o out.html`}
	input={RADAR_PROFILES_SAMPLE}
/>

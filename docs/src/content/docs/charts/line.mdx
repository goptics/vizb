...
Sample orders below (copy → `sales.csv`). Full file: [`examples/csv/sales.csv`](https://github.com/goptics/vizb/blob/main/examples/csv/sales.csv) (~500 rows, 2024–2025). Live: [tabular-data](https://vizb.goptics.org/examples/live/tabular-data/).

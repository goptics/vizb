...
<CardGrid>
  ...
  <Card title="Scatter Chart" icon="magnifier" href="/charts/scatter">
    Plot individual points in 2D or 3D. Grouped categories, raw numeric coordinates via `--axes`, or hybrid x/y + numeric z.
  </Card>
...
| **Scatter** | One point per X | One series per Y value across X | WebGL scatter3D — points per Z; or `--axes x,y,z` for continuous 3D |

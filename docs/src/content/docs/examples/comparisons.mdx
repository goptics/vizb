...
|-------|-----------|-------|-----------|
| HTTP framework throughput | [concurrency.csv](https://github.com/goptics/vizb/blob/main/examples/csv/concurrency.csv) | `-g load -p y -A x` | [Open](https://vizb.goptics.org/examples/live/comparisons/) |

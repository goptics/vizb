...
All of it visualizes the same way, up to **four dimensions**: add a z-axis for interactive [3D charts](/ui/3d-charts) with auto-rotate and axis-sum tooltips, or a flat [heatmap](/ui/heatmap). Charts ship as bar, line, pie, and heatmap, and each comes with a [statistics panel](/ui/stats) (descriptive metrics + a Pearson/Spearman correlation matrix).

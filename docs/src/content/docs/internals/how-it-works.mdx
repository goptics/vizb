...
<Tabs syncKey="format">
  ...
  Generic tabular data. A CSV table or a JSON array of objects is parsed into data points — numeric columns/fields become series, others can be promoted to Name / X / Y / Z with `--group`.

...
- uses: goptics/vizb@v0
  with:
    ...
    charts: line
    chart: |
      line:scale={type=log;axes=x,y;baseX=5;baseY=10};smooth
    output-html: pages/index.html
```

...
Invalid theme specs produce a soft warning and fall back to no embed / UI
default. Duplicate names (case-insensitive) keep first-seen order; last content
wins. Hex colors are `#rgb` or `#rrggbb`.

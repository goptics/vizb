...
Open `sales.html` in a browser. You get a grouped bar chart: region on X, category as series, one chart tab per numeric column (`quantity`, `amount`). The full repo sample is `examples/csv/sales.csv` (~500 orders across 2024–2025).

...
| `--theme` | | `default` | Initial series palette: `default`, `vintage`, `dark`, `westeros`, `essos`, `wonderland`, `walden`, `chalk`, `infographic`, `macarons`, `roma`, `shine`, `purple-passion`, or 2+ comma-separated hex colors |

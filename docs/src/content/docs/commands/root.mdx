...
| `--group` | `-g` | `""` | Labels each dimension in `--group-pattern` order. csv/json: column/field names whose values populate dimensions; benchmark parsers: human-readable labels for name/x/y/z axes |

---
title: Vizb
description: Turn any CSV or JSON table into interactive charts in one HTML file. Also supports benchmark output from Go, Rust, and JavaScript.
template: splash
hero:
  tagline: Any CSV or JSON table → interactive charts. One self-contained HTML file. No server, no build step.
  image:

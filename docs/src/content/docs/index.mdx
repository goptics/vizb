---
title: Vizb
description: Tabular data visualization engine for CSV, JSON, and benchmarks — interactive charts and descriptive statistics in one self-contained HTML file.
template: splash
hero:
  tagline: A tabular data visualization engine — turn CSV, JSON, and benchmarks into charts and stats in one self-contained HTML file. No server, no build step.
  image:
...
<CardGrid stagger>
  ...
  <Card title="Multi-Chart" icon="analytics">
    Bar, line, scatter, pie, heatmap, radar, Sankey, and Chord charts in one view. Choose which renderers to embed with `--charts`.
  </Card>
...
<CardGrid cols={2}>
  ...
  <LinkCard title="Group guide" description="Pattern and regex grouping for multi-dimensional data." href="/guides/group" />

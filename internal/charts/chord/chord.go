// Package chord defines the typed Config for chord charts. Chord is a
// circular edge diagram (source→target→value), so Config intentionally omits
// Scale, stack, ThreeDRotate, and visualMap — those do not apply.
package chord
...
// New returns a fresh zero-value chord chart Config.
